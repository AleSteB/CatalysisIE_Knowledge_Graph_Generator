...
with open("./ext_hydform_out_dict_base_own_mod.json") as f:
    label_data_own = json.load(f)

with open("./ext_hydform_out_dict_base_mod.json") as f:
...
with open("metrics_ext_hydform.csv", 'w', newline='') as csvfile:
