...
with open("./project_1_ext_hydform.json") as f:
...
for i in label_data:
    if i["id"] > 21:
        ...
        if abstract != None:
            ...
            for i in chem_list:
                if (i not in word_list_mod) and (not i.isdigit()):# and i in list(label_man_index.keys()):
                        try:
    ...
    with open("./ext_hydform_out_dict_base_mod.json", 'w') as f:
    #with open("./ext_hydform_out_dict_base_own_mod.json",'w') as f:
